...
//Key words: then/catch - will wait the result(resolved/rejected) of specified promise
...
//written after await or then
// and when await/then will get the data from promise - it will return it(((
